...
const About = () => {
  return (
   <section className='bg-gray-100 px-10 py-10 '>
    ...
    <h1 className="text-5xl font-extrabold text-[#1A1D1F] mt-10 mb-10 text-center">A platform for requesting all <br />
     your and educational letters</h1>
    <div className='flex justify-between'>
  <div className='flex-1 p-6 rounded-sm shadow-sm'>
